...
public:
	...
	void init() {
		...
		//in m
		gripper_length = 0.26;
		gripper_depth = 0.005;// for rear position use 0.01
...
//		handle_r_.orientation = marker_pose.orientation;
	...
	void create_stored_poses() {
		...
		pose.joint_states_r.push_back(1.56589);
		pose.joint_states_r.push_back(-1.12391);
		pose.joint_states_r.push_back(-1.98782);
		pose.joint_states_r.push_back(3.10651);
		pose.joint_states_r.push_back(-0.00336441);
		pose.joint_states_r.push_back(2.94691);
		pose.joint_states_l.push_back(-1.56685);
		pose.joint_states_l.push_back(-2.02354);
		pose.joint_states_l.push_back(1.99117);
		pose.joint_states_l.push_back(0.0084066);
		pose.joint_states_l.push_back(0.0039572);
		pose.joint_states_l.push_back(-2.91772);

		pose.pose.position.x = 0.345229;//0.315229
		pose.pose.position.y = 0;
		...
		pose.joint_states_r.push_back(1.56533);
		pose.joint_states_r.push_back(-1.09297);
		pose.joint_states_r.push_back(-2.2763);
		pose.joint_states_r.push_back(3.36589);
		pose.joint_states_r.push_back(-0.00371973);
		pose.joint_states_r.push_back(2.94508);
		pose.joint_states_l.push_back(-1.5664);
		pose.joint_states_l.push_back(-2.05499);
		pose.joint_states_l.push_back(2.27966);
		pose.joint_states_l.push_back(-0.247784);
		pose.joint_states_l.push_back(0.00511577);
		pose.joint_states_l.push_back(-2.91848);
		...
		pose.joint_states_r.push_back(-1.20425);
		pose.joint_states_r.push_back(-2.17328);
		pose.joint_states_r.push_back(-1.22912);
		pose.joint_states_r.push_back(3.40542);
		pose.joint_states_r.push_back(-2.77425);
		pose.joint_states_r.push_back(-3.33863);
		pose.joint_states_l.push_back(1.20257);
		pose.joint_states_l.push_back(-0.968084);
		pose.joint_states_l.push_back(1.22884);
		pose.joint_states_l.push_back(-0.262892);
		pose.joint_states_l.push_back(2.77413);
		pose.joint_states_l.push_back(3.33946);


		pose.pose.position.x = 1.4842;
		pose.pose.position.y = 0;
		pose.pose.position.z = 0.1124;
		pose.pose.orientation.x = 0;
		pose.pose.orientation.y = 0;
		pose.pose.orientation.z = 0;
		pose.pose.orientation.w = 1;
		...
		pose.joint_states_r.push_back(-1.21294);
		pose.joint_states_r.push_back(-2.27136);
		pose.joint_states_r.push_back(-1.26721);
		pose.joint_states_r.push_back(3.53942);
		pose.joint_states_r.push_back(-2.78295);
		pose.joint_states_r.push_back(-3.34078);
		pose.joint_states_l.push_back(1.21129);
		pose.joint_states_l.push_back(-0.870007);
		pose.joint_states_l.push_back(1.26692);
		pose.joint_states_l.push_back(-0.39686);
		pose.joint_states_l.push_back(2.78287);
