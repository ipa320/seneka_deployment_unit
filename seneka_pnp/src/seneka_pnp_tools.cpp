...
std::vector<dualArmJointState> seneka_pnp_tools::createArmStates() {
	...
	states.push_back(
			createArmState("prepack-rear", 1.55604, -0.348553, -1.12702,
					1.50556, -0.0127962, 2.91043, -1.558, -2.79, 1.12702,
					1.52883, 0.012214, -2.74885));
	states.push_back(
			createArmState("packed-rear", 1.58806, -1.43113, -1.80313, 3.21233,
					0.019241, 2.96233, -1.58925, -1.69424, 1.79061, 0.00715636,
					-0.0193046, -3.01626));
	states.push_back(
			createArmState("packed-rear-h1", 1.60587, -1.01243, -1.98466,
					2.98633, 0.0370389, 2.95235, -1.60649, -2.11752, 1.97315,
					0.199017, -0.0364981, -2.96735));
	states.push_back(
	...
	states.push_back(
			createArmState("pregrasp-rear-h5", 1.5, -1.0, 0, 3.141, 0, -1.7,
					-1.5, -2.1, 0, 0, 0, 1.7));
	states.push_back(
			createArmState("prepack", -1.06935, -1.70806, -1.08, 2.788, 3.64382,
					-3.339, 1.0674, -1.43427, 1.08065, 0.348302, 2.63745,
					3.36682));
	states.push_back(
			createArmState("packed-front", 0.535087, -0.777577, -1.87292,
					2.65096, -1.03374, -3.34183, -0.535293, -2.36387, 1.87334,
					0.488212, 1.03476, 3.37163));
	states.push_back(
			createArmState("packed-front-drop", 0.155798, -0.754735, -2.22018,
					2.97532, -1.41303, -3.34166, -0.157437, -2.387, 2.22061,
					0.164381, 1.41261, 3.37076));
	states.push_back(
	...
	states.push_back(
			createArmState("packed-front-tidy-3", -1.5, -0.754735, -1.8,
					...
					2.911));
	states.push_back(
			createArmState("pre-deploy-front", -1.2396, -2.21943, -0.603777,
					2.82442, -2.80843, -3.34044, 1.23781, -0.923922, 0.607145,
					0.310694, 2.80785, 3.3647));
	states.push_back(
			createArmState("deploy-front", -1.27622, -2.55643, -1.02015,
					3.57795, -2.84504, -3.34029, 1.27461, -0.586121, 1.02249,
					-0.443178, 2.84466, 3.36393));
