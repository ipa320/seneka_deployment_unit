...
std::vector<dualArmJointState> seneka_pnp_tools::createArmStates(){
	...
	states.push_back( createArmState("pregrasp-jointflip", 
										-1.9705, -2.441, -0.8, 3.2, -3.041, -3.3,
										1.9705, -0.7, 0.8, 0, 3.041, 3.3));
	...
	states.push_back( createArmState("packed-front", 
									0.535087, -0.777577, -1.87292, 2.65096, -1.03374, -3.34183,
									-0.535293, -2.36387, 1.87334, 0.488212, 1.03476, 3.37163) );
	states.push_back( createArmState("packed-front-drop",
									0.155798, -0.754735, -2.22018, 2.97532, -1.41303, -3.34166, 
									-0.157437, -2.387, 2.22061, 0.164381, 1.41261, 3.37076) );
	states.push_back( createArmState("packed-front-tidy-1", 
									-1.5, -0.754735, -2.22018, 2.97532, -1.41303, -2.9114,
									1.5, -2.387, 2.22061, 0.164381, 1.41261, 2.911) );
	states.push_back( createArmState("packed-front-tidy-2",
									-1.5, -0.754735, -1.8, 2.97532, -1.41303, -2.9114,
									1.5, -2.387, 1.8, 0.164381, 1.41261, 2.911));
	...
	states.push_back( createArmState("deploy-front", 
									-1.27622, -2.55643, -1.02015, 3.57795, -2.84504, -3.34029,	
									1.27461, -0.586121, 1.02249, -0.443178, 2.84466, 3.36393) );	
