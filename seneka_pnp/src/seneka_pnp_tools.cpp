...
std::vector<dualArmJointState> seneka_pnp_tools::createArmStates() {
	...
	states.push_back(createArmState("packed-rear", 1.57941, -1.28427, -1.9214, 3.18882, 0.00939698, 2.95844, -1.58052, -1.86413, 1.92621, -0.0797436, -0.00894785, -2.92393)
			);
	states.push_back(createArmState("packed-rear-h1", 1.59366, -0.861933, -2.03564, 2.89086, 0.0236436, 2.9483, -1.59398, -2.28216, 2.03645, 0.238651, -0.0224016, -2.93454)
			);
	states.push_back(
