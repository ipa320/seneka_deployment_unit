...
std::vector<dualArmJointState> seneka_pnp_tools::createArmStates() {
	...
	states.push_back(createArmState("packed-rear", 1.55143, -1.17746, -1.96807, 3.15404, -0.0185905, 2.93309, -1.55245, -1.96053, 1.96604, 0.00276344, 0.0191272, -2.94986)
			);
	states.push_back(createArmState("packed-rear-drop", 1.54945, -1.15932, -2.25221, 3.41921, -0.0205658, 2.93392, -1.55058, -1.97853, 2.25021, -0.264158, 0.0209965, -2.94912)
			);
	states.push_back(
